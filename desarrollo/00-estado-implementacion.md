...
| 05 FinOps cloud cost guardian | Analisis de costos, recomendaciones, provider HTTP estilo Cost Explorer configurable, fallback simulado y tests mockeados | Agregar metricas financieras y budget alerts |
