...
| 03 Event-driven notification hub | Consumidor idempotente, sender desacoplado, listener RabbitMQ, retry, DLQ, processed events persistentes e intentos/dead letters auditables | Validar flujo completo con Docker y agregar metricas de backlog |
