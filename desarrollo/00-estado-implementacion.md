...
| 04 Secure API gateway identity | Gateway, JWT resource server, issuer OIDC configurable, Redis rate limiting, correlation id y observabilidad | Agregar realm Keycloak reproducible y tests 401/403/429 |
