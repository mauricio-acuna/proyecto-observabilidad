...
| 03 Event-driven notification hub | Consumidor idempotente, sender desacoplado, listener RabbitMQ, retry configurado y DLQ declarada | Validar flujo completo con Docker y persistir intentos |
