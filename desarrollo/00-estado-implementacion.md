...
|---|---|---|
| 01 Plataforma soporte bancario | Base mas completa: dominio, use cases, adapters, REST, observabilidad, test | Reemplazar in-memory por PostgreSQL/Flyway y agregar outbox real |
