...
| Persistencia y eventos del proyecto 01 | Adapter JPA, Flyway, outbox, relay RabbitMQ y tests agregados; falta ejecutar integracion con Docker local | Validar con Docker disponible y conectar proyecto 03 como consumer real |
...
- Convertir proyecto 03 a broker real.
- Agregar retries y DLQ.
- Integrar eventos con proyecto 01.
